...
public class Time
{
    ...
    public Time(int id, String name, int age, String gender, String department, int yearOfJoining, double salary) {
        this.id = id;
        this.name = name;
        this.age = age;
        this.gender = gender;
    ...
    public static void main(String[] args) {
        ...
        Map<String ,Double> avarage =employeeList.
        ...
        Optional<Employee> ok =employeeList.stream().collect(Collectors.maxBy(Comparator.comparingDouble(Employee::getSalary)));
        System.out.println(ok);

        System.out.println("Get the names of all employees who have joined after 2015?");
        employeeList.stream().filter(aa ->aa.getYearOfJoining() >2015).map(Employee::getName).forEach(System.out::println);
